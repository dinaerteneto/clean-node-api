...
import { mockAccountModel, mockAddAccountParams, throwError } from '@/tests/domain'
...
describe('DbAddAccount Usecase', () => {
  ...
  test('Should thrown if Hasher throws', async () => {
    const { sut, hasherStub } = makeSut()
  ...
  test('Should thrown if addAccountRepository throws', async () => {
    const { sut, addAccountRepositoryStub } = makeSut()
